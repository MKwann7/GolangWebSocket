...
func (builder *Builder) GetById(entityId int, connection db.Connection, model interface{}) (interface{}, error) {
...
func (builder *Builder) GetByUuid(entityUuid uuid.UUID, connection db.Connection, model interface{}) (interface{}, error) {
...
func (builder *Builder) GetWhere(connection db.Connection, model interface{}, whereClause string, sort string, limit int) ([]interface{}, error) {
